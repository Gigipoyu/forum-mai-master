...
const readLikeByUserByPost  = async (id_user, id_post) => {
    ...
    const sql =  `
    SELECT 
    id FROM  liked_post WHERE id_user = ? && id_post = ? && liked = 1
`;
...
const readDislikeByUserByPost  = async (id_user, id_post) => {


    const sql =  `
    SELECT 
    id FROM  liked_post WHERE id_user = ? && id_post = ? && disliked = 1
`;
